...
const SignInForm = ({ setAdminReg }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://sleepy-mesa-34762.herokuapp.com/LogIn", {
        phone: data.phone,
      ...
      .then((res) => {
        ...
        // localStorage.setItem("adminRegion",res.data.regions)
        setAdminReg(res.data.regions);
        ...
        //  }
        if (res.data.key === "boss") {
          history.push("/boss");
          console.log("responseeeeeeeeeeeeeeeeeeee", res);
        } else {
          history.push("/adminSlider");
        }
      })
      .catch((err) => {
        history.push("/error");
